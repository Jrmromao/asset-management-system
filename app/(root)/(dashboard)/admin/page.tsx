...
const Admin = () => {
  ...
  const [shouldRefresh, licenses] = licenseStore((state) => [
    state.shouldRefresh,
    state.licenses,
  ]);
            ...
            <Tabs defaultValue="category">
              ...
              <TabsContent value="category">
                <Card x-chunk="dashboard-05-chunk-3">
                  ...
                  <CardContent className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-3">
              ...
              <TabsContent value="licenses">
                <Card x-chunk="dashboard-05-chunk-3">
                  <CardHeader className="px-7">
                    ...
                    <CardDescription>Register a new License.</CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-3">
                    <Card x-chunk="dashboard-05-chunk-1">
                      <CardHeader className="pb-2">
              ...
              <TabsContent value="people">
                <Card x-chunk="dashboard-05-chunk-3">
                  <CardHeader className="px-7">
                    ...
                    <CardDescription>Register a new People.</CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-3">
                    <Card x-chunk="dashboard-05-chunk-1">
                      <CardHeader className="pb-2">
