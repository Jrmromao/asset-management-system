...
const HelpPage = () => {
  ...
  const documentationResources = [
    {
      ...
      description:
        "Build your first maintenance flow in under 10 minutes with step-by-step instructions.",
    ...
    },
    {
      ...
      description:
        "Master every feature with comprehensive guides, real-world examples, and best practices.",
    ...
    },
    {
      ...
      description:
        "Quick solutions to common problems, error messages, and debugging techniques.",
  ...
  const supportResources = [
    ...
    },
    {
      ...
      title: "Email Support",
      description:
        "Send detailed questions and get comprehensive technical assistance.",
  ...
  const popularTopics = [
    {
      title: "Creating your first maintenance flow",
      views: 1250,
      difficulty: "Beginner",
    },
    {
    ...
    {
      title: "Troubleshooting flow triggers",
      views: 745,
      difficulty: "Beginner",
    },
            ...
            <CardContent>
              <div className="space-y-3">
                {popularTopics.map((topic, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-3 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg cursor-pointer transition-colors"
                  >
              ...
              >
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between">
                    <div
                      className={`p-3 rounded-lg ${resource.color} text-white`}
                    >
                      {resource.icon}
                    </div>
                    <Badge variant="outline" className="text-xs">
