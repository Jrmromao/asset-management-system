...
function MyComponent() {
  ...
  return (
    <div>
      ...
      {permissions.canCreateAssets && <Button>Create Asset</Button>}
...
function DashboardWidget() {
  const { renderIf, renderIfPermission, renderIfAdmin, renderIfCanPerform } =
    useConditionalRender();
  const permissions = usePermissions();
  ...
  return (
    <div>
      ...
      {renderIfPermission("assets.view", <div>Asset count: 42</div>)}
      ...
      {renderIfCanPerform("create", "users", <Button>Add User</Button>)}
  ...
  return (
    <tr>
      ...
      <td>
        ...
        {permissions.canViewAssets && <Button size="sm">View</Button>}
