...
const SortableField = ({ id, index, field, form, isPending, onRemove }: SortableFieldProps) => {
    const {
        attributes,
        listeners,
        setNodeRef,
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <Button
                                ...
                                size="sm"
                                onClick={() => {
                                    const currentOptions = form.watch(`fields.${index}.options`) || [];
                        ...
                        <div className="space-y-2">
                            {(form.watch(`fields.${index}.options`) || []).map((option: string, optionIndex: number) => (
...
const FormTemplateCreator = () => {
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col h-[calc(100vh-100px)]">
                {/* Fixed Header */}
