...
import { Clock, Activity, User, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-react';
...
const AuditLogTable = ({ logs }: AuditLogProps) => {
    ...
    return (
        <div className="w-full px-8"> {/* Added horizontal padding */}
            <div className="flex items-center justify-between mb-4">
                <div>
                    <p className="text-sm text-gray-500">System accessory assignment records</p>
                </div>
