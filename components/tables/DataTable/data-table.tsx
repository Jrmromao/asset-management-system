...
export function DataTable<TData, TValue>({
  ...
  const getCellContent = (cell: any) => {
    ...
    if (typeof content === "object") {
      return (
        cell.getValue() || cell.getContext().row.original[cell.column.id] || ""
      );
    }
      ...
      {row
        ...
        .map((cell: any) => {
          ...
          return (
            <div
              key={cell.id}
              className="flex flex-col py-4 border-b border-gray-200 bg-white last:border-b-0"
            >
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Pagination Controls */}
      <div
        className={`flex flex-col ${isMobile ? "space-y-4" : "sm:flex-row sm:justify-between"} items-center py-4 px-4`}
      >
