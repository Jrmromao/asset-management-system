// // useFormTemplateUIStore.ts
// import { create } from "zustand";
// import { findById, getAll, insert } from "@/lib/actions/formTemplate.actions";
//
...
interface IFormTemplateUIStore {
  isOpen: boolean;
  onOpen: () => void;
  onClose: () => void;
}

export const useFormTemplateUIStore = create<IFormTemplateUIStore>((set) => ({
  isOpen: false,
  onOpen: () => set({ isOpen: true }),
  onClose: () => set({ isOpen: false }),
}));
