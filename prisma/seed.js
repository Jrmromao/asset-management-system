...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var company, adminRole, department, user, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prisma.role.findFirst({ where: { name: 'Admin' } })];
                case 3:
                    adminRole = _a.sent();
                    if (!!adminRole) return [3 /*break*/, 5];
                    return [4 /*yield*/, prisma.role.create({ data: { name: 'Admin', active: true } })];
                case 4:
                    adminRole = _a.sent();
                    _a.label = 5;
                case 5: return [4 /*yield*/, prisma.department.findFirst({ where: { name: 'IT Department', companyId: company.id } })];
                case 6:
                    department = _a.sent();
                    if (!!department) return [3 /*break*/, 8];
                    return [4 /*yield*/, prisma.department.create({ data: { name: 'IT Department', companyId: company.id, active: true } })];
                case 7:
                    department = _a.sent();
                    _a.label = 8;
